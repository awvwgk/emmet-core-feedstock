...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/emmet-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/emmet-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install emmet-core
```
...
It is possible to list all of the versions of `emmet-core` available on your platform:
...
```
pixi search emmet-core --channel conda-forge
```
